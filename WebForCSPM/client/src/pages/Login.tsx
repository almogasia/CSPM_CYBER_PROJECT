...
/**
 * Login Component - User authentication and session management
 * Handles user login, token storage, and navigation to dashboard
 */
...
export default function Login({ onLogin }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upon successful login, store the token and username in sessionStorage (tab-specific).
