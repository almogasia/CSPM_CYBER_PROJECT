...
/**
 * Register Component - User registration with automatic login
 * Handles account creation, form validation, and session management
 */
...
export default function Register({ onLogin }: RegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The token and username are stored in sessionStorage (tab-specific).
